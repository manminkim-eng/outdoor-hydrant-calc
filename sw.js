/* ═══════════════════════════════════════════════════════════════
   ...
   NFPC 109 기준 | ENGINEER KIM MANMIN
   전략: Cache-First (로컬 자산) + Network-First (외부 CDN)
   ═══════════════════════════════════════════════════════════════ */

const CACHE_NAME   = 'outdoor-hydrant-v1.0';
const CDN_CACHE    = 'outdoor-hydrant-cdn-v1.0';
...
self.addEventListener('push', (event) => {
  const data = event.data?.json() ?? { title: '옥외소화전 계산서', body: '업데이트가 있습니다.' };
  event.waitUntil(
